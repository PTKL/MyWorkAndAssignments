 ...
 *
 */
public class RadiansToDegrees extends Operator {

	public RadiansToDegrees(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.toDegrees(a0.toDouble()));
