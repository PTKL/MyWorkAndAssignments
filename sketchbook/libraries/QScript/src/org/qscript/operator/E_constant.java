...
/**
 * E constant ( 2.7182818284590452354 )
 * 
 * @author Peter Lager
 *
 */
public class E_constant extends Operator {

	public E_constant(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		return new Argument(new Double(Math.E));
	}
