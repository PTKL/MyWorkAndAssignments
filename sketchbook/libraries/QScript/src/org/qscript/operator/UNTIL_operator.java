...
/**
 * UNTIL(boolean expr) end of the REPEAT_UNTIL loop. Loop exits if boolean expr = true
 * 
 * @author Peter Lager
 *
 */
public class UNTIL_operator extends FlowOperator {

	public UNTIL_operator(String symbol, int nbrArgs, int priority, int type) {
		super(FlowOperatorType.UNTIL, symbol, nbrArgs, priority, type);
	}
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		if(a0.isBoolean){
			...
			return result ? new FlowAction(FlowAction.NEXT) : new FlowAction(FlowAction.BACK);
		}
