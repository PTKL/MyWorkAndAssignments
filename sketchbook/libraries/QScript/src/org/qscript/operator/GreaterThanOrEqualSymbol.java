...
/**
 * &gte; logical comparison
 * 
 * @author Peter Lager
 *
 */
public class GreaterThanOrEqualSymbol extends Operator {

	public GreaterThanOrEqualSymbol(String symbol, int nbrArgs, int priority, int type) {
