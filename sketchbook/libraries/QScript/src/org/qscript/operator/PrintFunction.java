...
/**
 * Displays the argument in the console leaving the cursor on the same line.
 * 
 * @author Peter Lager
 *
 */
public class PrintFunction extends Operator{

	public PrintFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		System.out.print(a0.getValue().toString());
		return null;
	}
