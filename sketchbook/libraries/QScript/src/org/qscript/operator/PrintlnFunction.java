...
/**
 * Displays the argument in the console moving the cursor to the start of the next line.
 * 
 * @author Peter Lager
 *
 */
public class PrintlnFunction extends Operator {

	public PrintlnFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		script.fireEvent(OutputEvent.class, null, a0, a0.getValue().toString() + "\n");
		System.out.println(a0.getValue().toString());
		return null;
	}
