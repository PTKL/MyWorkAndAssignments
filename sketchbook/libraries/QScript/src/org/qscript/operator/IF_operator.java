...
/**
 * IF(boolean expr) keyword
 * 
 * @author Peter Lager
 *
 */
public class IF_operator extends FlowOperator {

	public IF_operator(String symbol, int nbrArgs, int priority, int type) {
		super(FlowOperatorType.IF, symbol, nbrArgs, priority, type);
	}
