 ...
 *
 */
public class REPEAT_operator extends FlowOperator {

	public REPEAT_operator(String symbol, int nbrArgs, int priority, int type) {
		super(FlowOperatorType.REPEAT, symbol, nbrArgs, priority, type);
	}

	@Override
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
			throws EvaluationException {
		// Go to following instruction
