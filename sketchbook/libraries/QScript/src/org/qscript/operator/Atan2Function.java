 ...
 *
 */
public class Atan2Function extends Operator {

	public Atan2Function(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		if(a0.isNumeric && a1.isNumeric){
			return new Argument(Math.atan2(a0.toDouble(), a1.toDouble()));	
		}
