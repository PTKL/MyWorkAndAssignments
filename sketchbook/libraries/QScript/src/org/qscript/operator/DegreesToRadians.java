 ...
 *
 */
public class DegreesToRadians extends Operator {

	public DegreesToRadians(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.toRadians(a0.toDouble()));
