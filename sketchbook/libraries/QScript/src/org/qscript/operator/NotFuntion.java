...
/**
 * NOT function flips a boolean value.
 * 
 * @author Peter Lager
 *
 */
public class NotFuntion extends Operator {

	public NotFuntion(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isBoolean){
			return new Argument(new Boolean(!a0.toBoolean()));
		}
