...
public class TanFunction extends Operator {
	...
	public TanFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.tan(a0.toDouble()));
		if(a0.isComplex)
			return new Argument(Complex.tan(((Complex)a0.getValue())));
