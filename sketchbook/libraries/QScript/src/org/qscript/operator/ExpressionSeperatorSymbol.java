...
/**
 * ; symbol (expression separator)
 * 
 * @author Peter Lager
 *
 */
public class ExpressionSeperatorSymbol extends Operator {

	public ExpressionSeperatorSymbol(String symbol, int nbrArgs, int priority, int type) {
