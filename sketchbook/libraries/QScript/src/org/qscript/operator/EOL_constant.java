...
/**
 * EOL constant (ASCII 10 )
 * 
 * @author Peter Lager
 *
 */
public class EOL_constant extends Operator {

	public EOL_constant(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		return new Argument(new String("\n"));
	}
