...
public class CosFunction extends Operator {
	...
	public CosFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.cos(a0.toDouble()));
		if(a0.isComplex)
			return new Argument(Complex.cos(((Complex)a0.getValue())));
