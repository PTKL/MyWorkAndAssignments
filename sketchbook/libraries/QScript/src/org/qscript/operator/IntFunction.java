...
/**
 * int() function - returns the number without the fractional part.
 * 
 * @author Peter Lager
 *
 */
public class IntFunction extends Operator {
	...
	public IntFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(a0.toInteger());
