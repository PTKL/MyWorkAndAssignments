 ...
 *
 */
public class AndSymbol extends Operator {

	public AndSymbol(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		if(a0.isBoolean && a1.isBoolean){
			return new Argument(new Boolean(a0.toBoolean() && a1.toBoolean()));
		}
