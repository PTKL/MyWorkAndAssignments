...
public class View extends JFrame {
  ...
  public View(final String title) {
    ...
    c.weightx = 1.0;
    c.weighty = 1.0;
    c.insets = new Insets(DEFAULT_GAP, DEFAULT_GAP, DEFAULT_GAP, DEFAULT_GAP);
  ...
  public void setPersonnelViewListener(ActionListener personnelListener) {
    this.projectPersonelButton.addActionListener(personnelListener);
    this.coWorkersButton.addActionListener(personnelListener);
  }

  public void setCostViewListener(ActionListener costListener) {
    this.projectCostButton.addActionListener(costListener);
    this.developerCostButton.addActionListener(costListener);
  }

  public void setAddHoursListener(ActionListener hoursListener) {
    this.addTimeButton.addActionListener(hoursListener);
  }

  public void setOpenCloseListener(ActionListener openCloseListener) {
    this.openCloseStoryButton.putClientProperty("type: ", ItemType.STORY);
    this.openCloseStoryButton.addActionListener(openCloseListener);
    this.openCloseProjectButton.putClientProperty("type: ", ItemType.PROJECT);
    this.openCloseProjectButton.addActionListener(openCloseListener);
  }

  public void addDeveloperListener(ActionListener developerListener) {
    this.addDeveloperButton.addActionListener(developerListener);
  }

  public void setCreateListeners(ActionListener creatingListener) {
    this.createDeveloperButton.addActionListener(creatingListener);
    this.createProjectButton.addActionListener(creatingListener);
    this.createStoryButton.addActionListener(creatingListener);
  }
