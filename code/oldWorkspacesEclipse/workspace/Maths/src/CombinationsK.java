 ...
 * 
 * Enumerates all subsets of size k on N elements in lexicographic order. Two
 * different solutions. Uses some String library functions.
 *
 * % java CombinationsK 5 3 abc abd abe acd ace ade bcd bce bde cde
 *
 *************************************************************************/
...
public class CombinationsK {
	...
	// prefix
	public static void comb1(String s, int k) {
		comb1(s, "", k);
	}
	...
	// read in N and k from command line, and print all subsets of size k from N
	// elements
