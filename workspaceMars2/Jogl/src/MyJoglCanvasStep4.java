 ...
 * @since 26 Feb 2009
 */
public class MyJoglCanvasStep4 extends GLCanvas implements GLEventListener {
     ...
     */
    public MyJoglCanvasStep4(GLCapabilities capabilities, int width, int height) {
    ...
    public final static void main(String[] args) {
        ...
        MyJoglCanvasStep4 canvas = new MyJoglCanvasStep4(capabilities, 800, 500);
