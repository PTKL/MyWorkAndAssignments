...
public class IoTDeviceService extends Service {
    ...
    class IoTDeviceThread extends Thread {
        ...
        {
            Intent intent = new Intent(IoTDeviceService.this, IotDeviceClient.class);
            PendingIntent pIntent = PendingIntent.getActivity(IoTDeviceService.this, 0, intent, 0);
            ...
            Notification n = new Notification.Builder(IoTDeviceService.this)
        ...
        public void RequestForNewToken(SQLiteDatabase db)
        {
            try {
                ...
                Log.d("IoTDeviceService", "Token: " + token);
                DatabaseUtil.UpdateToken(db,email,token);
            } catch (GooglePlayServicesAvailabilityException e) {
                Log.d("IoTDeviceService", "R U There :" + e.getMessage());
            } catch (UserRecoverableAuthException e) {
                Log.d("IoTDeviceService", "User :" + e.getMessage());
            } catch (IOException e) {
                Log.d("IoTDeviceService", "IO :" + e.getMessage());
            } catch (GoogleAuthException e) {
                Log.d("IoTDeviceService", "Auth :" + e.getMessage());
            } catch (Exception e) {
        ...
        public WorksheetEntry GetWorkSheetEntry(SpreadsheetService service, SpreadsheetEntry spreadSheet, String sheetName)
        {
            ...
            {
                Log.d("IotDeviceClient", e.getMessage());
            }
            catch(Exception e)
            {
                Log.d("IotDeviceClient",e.getMessage());
        ...
        public void GetSpreadSheetData()
        {
            ...
            String email = DatabaseUtil.GetLastUser(db);
            Log.d("IoTDeviceService","Email:" + email);
        ...
        public void UpdateCell(WorksheetEntry we, SpreadsheetService s, int row, int col, String text)
        {
            try {
                ...
                CellEntry cellEntry = new CellEntry(row, col, text);
