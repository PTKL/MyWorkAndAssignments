...
public class BruteForce {
  ...
  public ArrayList<RouteBruteForce> permuteCities(int x, RouteBruteForce currentRoute,
      RouteBruteForce shortestRoute) {
    ...
    if (x == currentRoute.getCities().size() - 1) {
      ...
      if ((int) calculateTotalDistance(currentRoute) <= (int) calculateTotalDistance(
          shortestRoute)) {
