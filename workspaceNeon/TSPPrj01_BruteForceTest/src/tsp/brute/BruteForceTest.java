...
public class BruteForceTest {
	...
	/**
	 * Run the void addToShortestRoutes(Route) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 9/20/16 11:20 PM
	...
	/**
	 * Run the int calculateTotalDistance(Route) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 9/20/16 11:20 PM
	...
	/**
	 * Run the String getTotalDistance(Route) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 9/20/16 11:20 PM
	...
	/**
	 * Run the ArrayList<Route> permuteCities(int,Route,Route) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 9/20/16 11:20 PM
	...
	public void testPermuteCities_1()
		...
		Route shortestRoute = new Route(new ArrayList());

		ArrayList<Route> result = fixture.permuteCities(x, currentRoute, shortestRoute);
